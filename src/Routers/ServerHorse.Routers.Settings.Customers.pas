unit ServerHorse.Routers.Settings.Customers;
  ...
  .Post('/customers',
    ...
    begin
      ...
      try
        ...
        TController.New.CUSTOMERS.This.Settings.InsertConfig(vBody);
  ...
  .Put('/customers/settings/:ID',
    ...
    begin
      ...
      try
        ...
        TController.New.CUSTOMERS.This.Settings.UpdateConfig(vBody);
        Res.Status(200).Send<TJsonObject>(vBody);
      except
        Res.Status(500).Send('');
      end;
